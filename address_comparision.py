...
with open('//Users/home/Desktop/GTFH_totaladdresses.txt', 'r') as file:
    firsthalfaddys = file.read().splitlines()

# Filter the data in the Excel file from the .txt file
filtered_list = fcfs_provisional_list[fcfs_provisional_list['Address'].isin(firsthalfaddys)]

# Output the filtered data as .csv
filtered_list.to_csv('/Users/home/Desktop/GTFH_filtered_fcfs_provisional_list.xlsx', index=False)
